  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl uppercase tracking-wide text-sm font-bold ring-offset-background transition-colors outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-orange-500 text-primary-foreground hover:bg-orange-500/90 border-orange-600 border-t-white border-b-4 active:border-b-0 active:border-t-4",
        secondaryOutline: "bg-white text-orange-500 hover:bg-orange-50",
        danger:
        ...
        super:
          "bg-yellow-500 text-primary-foreground hover:bg-yellow-500/90 border-yellow-600 border-t-white border-b-4 active:border-b-0 active:border-t-4",
        superOutline: "bg-white text-yellow-500 hover:bg-yellow-50",
        sidebar:
